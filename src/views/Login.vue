        ...
        <div class="login_wrap_main_form">
          ...
          >
            <el-form-item label="" class="item" prop="name">
              <el-input prefix-icon="el-icon-user" v-model="user_form.name" autocomplete="off" placeholder="请输入用户名"></el-input>
            </el-form-item>
            <el-form-item label="" class="item" prop="pwd">
              <el-input prefix-icon="el-icon-lock" v-model="user_form.pwd" type="password" autocomplete="off" placeholder="请输入密码"></el-input>
            </el-form-item>
            <el-form-item label="" class="item code" prop="code">
              <el-input prefix-icon="el-icon-edit-outline" v-model="user_form.code" autocomplete="off" placeholder="请输入验证码"></el-input>
              <img 
                class="code_img"
