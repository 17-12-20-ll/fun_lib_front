<template>
  <div class="content">
    <div class="top">
      <el-input class="admin" v-model="inputGroupName" placeholder="请输入内容" label="组名称" clearable>
        <template slot="prepend">组名称：</template>
      </el-input>
      <el-button type="primary" size="mini" class="btn" @click="query">查询</el-button>
      <el-button type="success" size="mini" class="btn" @click="handleAdd">添加</el-button>
    </div>
    <el-table
      ref="multipleTable"
      :data="groups"
